  ...
  return (
    <div className="public-page min-h-screen bg-white">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled 
          ? 'backdrop-blur-xl bg-gradient-to-br from-white/80 via-green-50/40 via-white/70 via-green-100/30 via-white/80 to-white/75 border-b border-green-200/50 shadow-lg' 
          : 'backdrop-blur-md bg-gradient-to-br from-white/85 via-green-50/35 via-white/75 via-green-100/25 via-white/85 to-white/80 border-b border-green-200/40'
      }`}>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            {!isMobile && (
              <nav className="hidden md:flex items-center gap-8">
                <button onClick={() => scrollToSection('facilities')} className="text-gray-800 hover:text-green-600 transition-colors font-medium">
                  Facilities
                </button>
                <button onClick={() => scrollToSection('pricing')} className="text-gray-800 hover:text-green-600 transition-colors font-medium">
                  Pricing
                </button>
                <button onClick={() => scrollToSection('about')} className="text-gray-800 hover:text-green-600 transition-colors font-medium">
                  About
                </button>
                <button onClick={() => scrollToSection('reviews')} className="text-gray-800 hover:text-green-600 transition-colors font-medium">
                  Reviews
                </button>
                <button onClick={() => navigate('/support')} className="text-gray-800 hover:text-green-600 transition-colors font-medium">
                  Contact
                </button>
              </nav>
            )}
          ...
          <Button
              ...
              {isMobile && (
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-green-100 text-gray-800 transition-colors"
                >
        ...
        {mobileMenuOpen && isMobile && (
          <div className="md:hidden border-t border-green-200/50 bg-gradient-to-br from-white/85 via-green-50/35 via-white/75 via-green-100/25 via-white/85 to-white/80 backdrop-blur-xl">
            <div className="px-4 py-4 space-y-3">
              <button onClick={() => scrollToSection('facilities')} className="block w-full text-left px-4 py-2 rounded-lg hover:bg-green-100 text-gray-800 font-medium">
                Facilities
              </button>
              <button onClick={() => scrollToSection('pricing')} className="block w-full text-left px-4 py-2 rounded-lg hover:bg-green-100 text-gray-800 font-medium">
                Pricing
              </button>
              <button onClick={() => scrollToSection('about')} className="block w-full text-left px-4 py-2 rounded-lg hover:bg-green-100 text-gray-800 font-medium">
                About
              </button>
              <button onClick={() => scrollToSection('reviews')} className="block w-full text-left px-4 py-2 rounded-lg hover:bg-green-100 text-gray-800 font-medium">
                Reviews
              </button>
              <button onClick={() => navigate('/support')} className="block w-full text-left px-4 py-2 rounded-lg hover:bg-green-100 text-gray-800 font-medium">
                Contact
              </button>
            </div>
          </div>
